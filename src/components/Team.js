...
import juliarose from './img/juliarose21.jpg';
...
const Team = () => {
    return (
        ...
        <section className="team-section my-5">
                      ...
                      <div className="col-xl-6 col-lg-12 mb-5 d-md-flex justify-content-between">
                        <div className="avatar mb-md-0 mb-4 mx-4 team" style = {{ width: "60%", height: "100%" }}>
                  ...
                  <div className="row text-center text-md-left">
                    ...
                    <div className="col-xl-6 col-lg-12 mb-xl-0 mb-5 d-md-flex justify-content-between">
                      ...
                      <div className="mx-4">
                        ...
                        <h6 className="font-weight-bold grey-text mb-3">NSERC Student</h6>
                    ...
                    <div className="col-xl-6 col-lg-12 d-md-flex justify-content-between">
                      ...
                      <div className="mx-4">
                        ...
                        <h6 className="font-weight-bold grey-text mb-3">NSERC Student</h6>
                        <p className="grey-text">Julia is currently completing her BSc (Hons) in Psychology. She is working with Dr. Fawcett and Dr. Rash to determine the cognitive mechanisms involved in managing past and future painful events.</p>
                  ...
                  <div className="row text-center text-md-left my-5">
                    ...
                    <div className="col-xl-6 col-lg-12 d-md-flex justify-content-between">
                    <div className="avatar mb-md-0 mb-4 mx-4" style = {{ width: "35%", height: "100%" }}>
            ...
            <div className="row text-center text-md-left my-5">
                ...
                <div className="col-xl-6 col-lg-12 mb-xl-0 mb-5 d-md-flex justify-content-between">
                <div className="avatar mb-md-0 mb-4 mx-4" style = {{ width: "34%", height: "100%" }}>
                    <img src={julia} className="rounded z-depth-1" style = {{ width: "100%", height: "100%" }} alt="Sample avatar"/>
                </div>
                <div className="mx-4">
                    <h4 className="font-weight-bold mb-3">Michael Foote</h4>
                    <h6 className="font-weight-bold grey-text mb-3">Volunteer</h6>
                    <p className="grey-text">Michael has been involved with the Neurofog lab as a volunteer</p>
                </div>
                </div>
                ...
                <div className="mx-4">
                    <h4 className="font-weight-bold mb-3">Kathleen Janette C. Prior</h4>
                    <h6 className="font-weight-bold grey-text mb-3">Volunteer</h6>
