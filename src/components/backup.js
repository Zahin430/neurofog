...
export default class Team extends Component {
    ...
    return (
        ...
        <section className="team-section">
                    ...
                    <div className= "row text-md-left pt-2 text-center justify-content-center " style = {{width: '95%', paddingBottom: '5%', marginLeft: '50px'}}>
              
                    <div className=" col-xl-6 col-md-4 col-sm-8 col-lg-12 mb-5 d-md-flex justify-content-between" >
